...
wget -O /etc/asound.conf https://raw.githubusercontent.com/tarekzoka/ipaudio/main/arm-os/asound.conf
...
wget -O /usr/lib/libasound.so.2.0.0 https://raw.githubusercontent.com/tarekzoka/ipaudio/main/arm-os/libasound.so.2.0.0
